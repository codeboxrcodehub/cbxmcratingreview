...
if ( ! class_exists( 'CBXMCRatingReviewReviewUserAlertEmail', false ) ) :
	 ...
	 *
	 * Sending email alert to user when user review an object from frontend
	 */
	class CBXMCRatingReviewReviewUserAlertEmail extends CBXMCRatingReviewEmail {
		/**
		 * Constructor.
		 */
		public function __construct() {
			$this->id          = 'new_review_user_alert';
			$this->user_email  = true; //alert for admin
			$this->title       = esc_html__( 'New review user email alert', 'cbxmcratingreview' );
			$this->description = esc_html__( 'Sends notification to user on review creation.', 'cbxmcratingreview' );

			$this->template_html = 'emails/new_review_user_alert.php';
		...
		public function get_default_subject() {
			return esc_html__( 'New Review Notification', 'cbxmcratingreview' );
		...
		public function get_default_heading() {
			return esc_html__( 'New Review', 'cbxmcratingreview' );
	...
	}//end class CBXMCRatingReviewReviewUserAlertEmail
endif;

return new CBXMCRatingReviewReviewUserAlertEmail();