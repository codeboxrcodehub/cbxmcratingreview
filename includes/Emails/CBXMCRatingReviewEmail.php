...
class CBXMCRatingReviewEmail {
	...
	public function __construct() {
		...
		add_filter( 'cbxmcratingreview_email_footer_text', [ $this, 'footer_text_format' ] );
	}//end constructor
...
/**
	...
	public function init_form_fields() {
		...
		$placeholder_text  = sprintf( __( 'Available placeholders: %s', 'cbxmcratingreview' ), '<code>' . esc_html( implode( '</code>, <code>', array_keys( $this->placeholders ) ) ) . '</code>' );
		$this->form_fields = [
			'enabled'            => [
			...
			'additional_content' => [
				...
				'description' => esc_html__( 'Text to appear below the main email content.', 'cbxmcratingreview' ) . ' ' . $placeholder_text,
			...
			'from_name'          => [
				...
				'type'        => 'text',
				'desc_tip'    => true,
				'description' => esc_html__( 'Email sent from name. Put empty to set this from WordPress core or via any smtp plugin.', 'cbxmcratingreview' ),
			...
			'cc'                 => [
				...
				'type'        => 'text',
				'desc_tip'    => true,
				'description' => esc_html__( 'Email Recipient(s) as CC. Put multiple as comma.', 'cbxmcratingreview' ),
			...
			'bcc'                => [
				...
				'type'        => 'text',
				'desc_tip'    => true,
				'description' => esc_html__( 'Email Recipient(s) as BCC. Put multiple as comma.', 'cbxmcratingreview' ),
				'placeholder' => esc_html__( 'Email', 'cbxmcratingreview' ),
				'default'     => ''
			],
			'replyto'            => [
				'title'       => esc_html__( 'Reply To', 'cbxmcratingreview' ),
				'type'        => 'text',
				'desc_tip'    => true,
				'description' => wp_kses( __( 'Email reply to. If empty then will be used from <strong>From Email</strong>.', 'cbxmcratingreview' ), cbxmcratingreviewHelper::allowedHtmlTags() ),
				'placeholder' => esc_html__( 'Reply to email', 'cbxmcratingreview' ),
				'default'     => ''
			],
		];
	...
	public function get_email_type_options() {
		$types = [ 'plain' => esc_html__( 'Plain text', 'cbxmcratingreview' ) ];

		if ( class_exists( 'DOMDocument' ) ) {
			$types['html']      = esc_html__( 'HTML', 'cbxmcratingreview' );
			$types['multipart'] = esc_html__( 'Multipart', 'cbxmcratingreview' );
		}
	...
	public function init_settings() {
		$email_settings = get_option( 'cbxmcratingreview_emails', [] );
	...
	public function get_form_fields() {
		return apply_filters( 'cbxmcratingreview_email_form_fields_' . $this->id, array_map( [
			$this,
			'set_defaults'
		], $this->form_fields ) );
	...
	public function get_title() {
		return apply_filters( 'cbxmcratingreview_email_title', $this->title, $this );
	...
	public function get_description() {
		return apply_filters( 'cbxmcratingreview_email_description', $this->description, $this );
	}//end method get_cc
	...
	public function is_enabled() {
		return apply_filters( 'cbxmcratingreview_email_enabled_' . $this->id, 'yes' === $this->enabled, $this->object, $this );
	}//end method get_bcc
	...
	public function get_subject() {
		return apply_filters( 'cbxmcratingreview_email_subject_' . $this->id, $this->format_string( $this->get_option( 'subject', $this->get_default_subject() ) ), $this->object, $this );
	...
	public function format_string( $string ) {
		 ...
		 * @since 3.2.0
		 */
		return apply_filters( 'cbxmcratingreview_email_format_string', str_replace( $find, $replace, $string ), $this );
	...
	public function get_heading() {
		return apply_filters( 'cbxmcratingreview_email_heading_' . $this->id, $this->format_string( $this->get_option( 'heading', $this->get_default_heading() ) ), $this->object, $this );
	}//end function send
	...
	public function get_recipient() {
		//$recipient  = apply_filters( 'cbxmcratingreview_email_recipient_' . $this->id, $this->get_option( 'recipient', $this->get_default_recipient() ), $this->object, $this );

		$recipient = apply_filters( 'cbxmcratingreview_email_recipient_' . $this->id, $this->recipient, $this->object, $this );
		if ( $recipient !== null ) {
...
/**
	...
	public function get_headers() {
		...
		return apply_filters( 'cbxmcratingreview_email_headers', $header, $this->id, $this->object, $this );
	...
	public function get_content_type( $default_content_type = '' ) {
		...
		return apply_filters( 'cbxmcratingreview_email_content_type', $content_type, $this, $default_content_type );
...
/**
	...
	public function get_cc() {
		$cc = apply_filters( 'cbxmcratingreview_email_cc_' . $this->id, $this->get_option( 'cc', '' ), $this->object, $this );
	...
	public function get_bcc() {
		$bcc = apply_filters( 'cbxmcratingreview_email_bcc_' . $this->id, $this->get_option( 'bcc', '' ), $this->object, $this );
	...
	public function get_replyto() {
		$reply_to = apply_filters( 'cbxmcratingreview_email_replyto_' . $this->id, $this->get_option( 'replyto', '' ), $this->object, $this );
	...
	public function get_from_email( $from_email = '' ) {
		$from_email = apply_filters( 'cbxmcratingreview_email_from_email_' . $this->id, $this->get_option( 'from_email', '' ), $this->object, $this, $from_email );
	...
	public function get_from_name( $from_name = '' ) {
		$from_name = apply_filters( 'cbxmcratingreview_email_from_name_' . $this->id, trim( $this->get_option( 'from_name', '' ) ), $this->object, $this, $from_name );
...
/**
	...
	public function send( $to, $subject, $message, $headers, $attachments ) {
		...
		$message              = apply_filters( 'cbxmcratingreview_mail_content', $this->style_inline( $message ) );
		$mail_callback        = apply_filters( 'cbxmcratingreview_mail_callback', 'wp_mail', $this );
		$mail_callback_params = apply_filters( 'cbxmcratingreview_mail_callback_params', [
			$to,
		 ...
		 * @param CBXMCRatingReviewEmail $this CBXMCRatingReviewEmail instance.
		 *
		 * @since 5.6.0
		 */
		do_action( 'cbxmcratingreview_email_sent', $return, $this->id, $this );
	...
	public function style_inline( $content ) {
		if ( in_array( $this->get_content_type(), [ 'text/html', 'multipart/alternative' ], true ) ) {
			 ...
			 * @param \CBXMCRatingReviewEmail $email E-mail instance.
			 *
			 * @since 2.3.0
			 *
			 */
			$css = apply_filters( 'cbxmcratingreview_email_styles', $css, $this );
			...
			if ( $this->supports_emogrifier() && class_exists( $css_inliner_class ) ) {
				try {
					...
					do_action( 'cbxmcratingreview_emogrifier', $css_inliner, $this );
	...
	public function get_attachments() {
		return apply_filters( 'cbxmcratingreview_email_attachments', [], $this->id, $this->object, $this );
	...
	public function get_additional_content() {
		 ...
		 * @param CBXMCRatingReviewEmail $email CBXMCRatingReviewEmail instance managing the email.
		 *
		 * @since 3.7.0
		 *
		 */
		return apply_filters( 'cbxmcratingreview_email_additional_content_' . $this->id, $this->format_string( $this->get_option( 'additional_content' ) ), $this->object, $this );
...
}//end class CBXMCRatingReviewEmail