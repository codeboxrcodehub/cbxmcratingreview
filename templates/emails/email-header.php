 ...
 * Email Header
 *
 * This template can be overridden by copying it to yourtheme/cbxmcratingreview/emails/email-header.php.
 *
                    ...
                    <tr>
                        <td align="center" valign="top">
                            <div id="template_header_image">
								<?php
								//$img = get_option( 'cbxmcratingreview_email_header_image' );
