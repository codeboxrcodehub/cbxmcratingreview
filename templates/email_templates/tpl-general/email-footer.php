 ...
 * Email Footer
 *
 * This template can be overridden by copying it to plugins_folder/cbxmcratingreview/email_templates/tpl-general/email-footer.php.
 *
 */
							...
							<?php
								...
								echo wp_kses_post(
									wpautop(
										 ...
										 *
										 */
											apply_filters( 'cbxmcratingreview_email_footer_text', $footer_text )
										)
									)
								);
								?>
...
<!--							<a href="https://yoursite.com/unsubscribe" class="footer-link">Unsubscribe</a> |
    ...
    <tr>
        <td height="50" style="line-height:50px; font-size:0;">&nbsp;</td>
    </tr>
</table>
</body>
</html>