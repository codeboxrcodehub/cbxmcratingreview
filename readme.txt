...
* 	Multi Forms compatible(every form has different setting for rating)
...
*   See the pro-addons for pro features
...
* [updated] Style improved
* [fixed] Js loading logic improved
* [updated] Pro Addon plugin V2.0.4 released
...
* [new] Plugin check plugin V1.4.0 compatible
* [new] Pro Addon plugin V2.0.0 compatible
