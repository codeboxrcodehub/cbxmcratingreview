...
namespace CBXMCRatingReviewScoped\Illuminate\Container;

use ArrayAccess;
use Closure;
use Exception;
use CBXMCRatingReviewScoped\Illuminate\Contracts\Container\BindingResolutionException;
use CBXMCRatingReviewScoped\Illuminate\Contracts\Container\CircularDependencyException;
use CBXMCRatingReviewScoped\Illuminate\Contracts\Container\Container as ContainerContract;
use LogicException;
use ReflectionClass;
