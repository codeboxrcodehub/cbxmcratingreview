...
use Closure;
use CBXMCRatingReviewScoped\Faker\Generator;
use CBXMCRatingReviewScoped\Illuminate\Container\Container;
use CBXMCRatingReviewScoped\Illuminate\Contracts\Foundation\Application;
...
abstract class Factory
{
    ...
    {
        return new EloquentCollection(collect($records)->map(function ($record) {
