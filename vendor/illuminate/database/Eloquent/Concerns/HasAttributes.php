...
namespace CBXMCRatingReviewScoped\Illuminate\Database\Eloquent\Concerns;

use CBXMCRatingReviewScoped\Carbon\CarbonImmutable;
use CBXMCRatingReviewScoped\Carbon\CarbonInterface;
use DateTimeInterface;
use CBXMCRatingReviewScoped\Illuminate\Contracts\Database\Eloquent\Castable;
use CBXMCRatingReviewScoped\Illuminate\Contracts\Database\Eloquent\CastsInboundAttributes;
use CBXMCRatingReviewScoped\Illuminate\Contracts\Support\Arrayable;
use CBXMCRatingReviewScoped\Illuminate\Database\Eloquent\Casts\AsArrayObject;
use CBXMCRatingReviewScoped\Illuminate\Database\Eloquent\Casts\AsCollection;
use CBXMCRatingReviewScoped\Illuminate\Database\Eloquent\Casts\Attribute;
use CBXMCRatingReviewScoped\Illuminate\Database\Eloquent\InvalidCastException;
use CBXMCRatingReviewScoped\Illuminate\Database\Eloquent\JsonEncodingException;
use CBXMCRatingReviewScoped\Illuminate\Database\Eloquent\Relations\Relation;
use CBXMCRatingReviewScoped\Illuminate\Database\LazyLoadingViolationException;
use CBXMCRatingReviewScoped\Illuminate\Support\Arr;
use CBXMCRatingReviewScoped\Illuminate\Support\Carbon;
use CBXMCRatingReviewScoped\Illuminate\Support\Collection as BaseCollection;
use CBXMCRatingReviewScoped\Illuminate\Support\Facades\Crypt;
use CBXMCRatingReviewScoped\Illuminate\Support\Facades\Date;
...
trait HasAttributes
{
    ...
    {
        static::$getAttributeMutatorCache[$class] = collect($attributeMutatorMethods = static::getAttributeMarkedMutatorMethods($class))->mapWithKeys(function ($match) {
            return [lcfirst(static::$snakeAttributes ? Str::snake($match) : $match) => \true];
        })->all();
        static::$mutatorCache[$class] = collect(static::getMutatorMethods($class))->merge($attributeMutatorMethods)->map(function ($match) {
