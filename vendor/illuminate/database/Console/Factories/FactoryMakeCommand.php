...
namespace CBXMCRatingReviewScoped\Illuminate\Database\Console\Factories;

use CBXMCRatingReviewScoped\Illuminate\Console\GeneratorCommand;
...
class FactoryMakeCommand extends GeneratorCommand
{
    ...
    protected function buildClass($name)
    {
        ...
        if (Str::startsWith($namespaceModel, $this->rootNamespace() . 'Models')) {
            ...
            $namespace = 'CBXMCRatingReviewScoped\Database\Factories';
        }
