...
namespace CBXMCRatingReviewScoped\Illuminate\Database\Query;

use BackedEnum;
use Closure;
use DateTimeInterface;
use CBXMCRatingReviewScoped\Illuminate\Contracts\Support\Arrayable;
use CBXMCRatingReviewScoped\Illuminate\Database\Concerns\BuildsQueries;
use CBXMCRatingReviewScoped\Illuminate\Database\Concerns\ExplainsQueries;
use CBXMCRatingReviewScoped\Illuminate\Database\ConnectionInterface;
use CBXMCRatingReviewScoped\Illuminate\Database\Eloquent\Builder as EloquentBuilder;
use CBXMCRatingReviewScoped\Illuminate\Database\Eloquent\Relations\Relation;
use CBXMCRatingReviewScoped\Illuminate\Database\Query\Grammars\Grammar;
use CBXMCRatingReviewScoped\Illuminate\Database\Query\Processors\Processor;
use CBXMCRatingReviewScoped\Illuminate\Pagination\Paginator;
use CBXMCRatingReviewScoped\Illuminate\Support\Arr;
use CBXMCRatingReviewScoped\Illuminate\Support\Collection;
use CBXMCRatingReviewScoped\Illuminate\Support\LazyCollection;
use CBXMCRatingReviewScoped\Illuminate\Support\Str;
use CBXMCRatingReviewScoped\Illuminate\Support\Traits\ForwardsCalls;
use CBXMCRatingReviewScoped\Illuminate\Support\Traits\Macroable;
...
class Builder
{
    ...
    public function upsert(array $values, $uniqueBy, $update = null)
    {
        ...
        $this->applyBeforeQueryCallbacks();
        $bindings = $this->cleanBindings(array_merge(Arr::flatten($values, 1), collect($update)->reject(function ($value, $key) {
            return is_int($key);
        })->all()));
    ...
    {
        return collect($bindings)->reject(function ($binding) {
