...
use CBXMCRatingReviewScoped\League\CommonMark\GithubFlavoredMarkdownConverter;
use CBXMCRatingReviewScoped\Ramsey\Uuid\Codec\TimestampFirstCombCodec;
use CBXMCRatingReviewScoped\Ramsey\Uuid\Generator\CombGenerator;
use CBXMCRatingReviewScoped\Ramsey\Uuid\Uuid;
use CBXMCRatingReviewScoped\Ramsey\Uuid\UuidFactory;
use CBXMCRatingReviewScoped\voku\helper\ASCII;
class Str
{
    use Macroable;
    /**
