...
use CBXMCRatingReviewScoped\Illuminate\Http\Resources\Json\JsonResource;
...
use CBXMCRatingReviewScoped\Illuminate\Support\Traits\Tappable;
/**
...
abstract class AbstractCursorPaginator implements Htmlable
{
    ...
    {
        return collect($this->parameters)->flip()->map(function ($_, $parameterName) use ($item) {
