...
namespace CBXMCRatingReviewScoped\enshrined\svgSanitize\ElementReference;

use CBXMCRatingReviewScoped\enshrined\svgSanitize\data\XPath;
use CBXMCRatingReviewScoped\enshrined\svgSanitize\Exceptions\NestingException;
use CBXMCRatingReviewScoped\enshrined\svgSanitize\Helper;
class Resolver
{
    /**
     * @var XPath
