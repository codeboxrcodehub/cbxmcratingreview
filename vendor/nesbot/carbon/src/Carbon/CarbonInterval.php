 ...
 */
namespace CBXMCRatingReviewScoped\Carbon;

use CBXMCRatingReviewScoped\Carbon\Exceptions\BadFluentConstructorException;
use CBXMCRatingReviewScoped\Carbon\Exceptions\BadFluentSetterException;
use CBXMCRatingReviewScoped\Carbon\Exceptions\InvalidCastException;
use CBXMCRatingReviewScoped\Carbon\Exceptions\InvalidIntervalException;
use CBXMCRatingReviewScoped\Carbon\Exceptions\OutOfRangeException;
use CBXMCRatingReviewScoped\Carbon\Exceptions\ParseErrorException;
use CBXMCRatingReviewScoped\Carbon\Exceptions\UnitNotConfiguredException;
use CBXMCRatingReviewScoped\Carbon\Exceptions\UnknownGetterException;
use CBXMCRatingReviewScoped\Carbon\Exceptions\UnknownSetterException;
use CBXMCRatingReviewScoped\Carbon\Exceptions\UnknownUnitException;
use CBXMCRatingReviewScoped\Carbon\Traits\IntervalRounding;
use CBXMCRatingReviewScoped\Carbon\Traits\IntervalStep;
use CBXMCRatingReviewScoped\Carbon\Traits\MagicParameter;
use CBXMCRatingReviewScoped\Carbon\Traits\Mixin;
use CBXMCRatingReviewScoped\Carbon\Traits\Options;
use CBXMCRatingReviewScoped\Carbon\Traits\ToStringFormat;
use Closure;
use DateInterval;
