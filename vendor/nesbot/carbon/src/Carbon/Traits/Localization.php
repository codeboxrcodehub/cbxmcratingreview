 ...
 */
namespace CBXMCRatingReviewScoped\Carbon\Traits;

use CBXMCRatingReviewScoped\Carbon\CarbonInterface;
use CBXMCRatingReviewScoped\Carbon\Exceptions\InvalidTypeException;
use CBXMCRatingReviewScoped\Carbon\Exceptions\NotLocaleAwareException;
use CBXMCRatingReviewScoped\Carbon\Language;
use CBXMCRatingReviewScoped\Carbon\Translator;
use CBXMCRatingReviewScoped\Carbon\TranslatorStrongTypeInterface;
use Closure;
use CBXMCRatingReviewScoped\Symfony\Component\Translation\TranslatorBagInterface;
use CBXMCRatingReviewScoped\Symfony\Component\Translation\TranslatorInterface;
use CBXMCRatingReviewScoped\Symfony\Contracts\Translation\LocaleAwareInterface;
use CBXMCRatingReviewScoped\Symfony\Contracts\Translation\TranslatorInterface as ContractsTranslatorInterface;
// @codeCoverageIgnoreStart
if (interface_exists('CBXMCRatingReviewScoped\Symfony\Contracts\Translation\TranslatorInterface') && !interface_exists('CBXMCRatingReviewScoped\Symfony\Component\Translation\TranslatorInterface')) {
    class_alias('CBXMCRatingReviewScoped\Symfony\Contracts\Translation\TranslatorInterface', 'CBXMCRatingReviewScoped\Symfony\Component\Translation\TranslatorInterface');
}
